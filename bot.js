...
const { addGroup, addUser, addTask, getAllTasks, completeTask, deleteTask, submitForReview, approveTask, requestRevision, returnToWork, getUserRole, getSetting } = require(database);
